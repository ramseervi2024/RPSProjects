...
import { ChevronLeft, Play, Calendar, User, Phone, MapPin, X, Star, ShieldCheck, Download, Share2 } from 'lucide-react-native';
...
export default function ProfileDetails({ artist, onBack, isAlreadyBooked = false }) {
        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <View style={styles.bookingStatusCard}>
                        ...
                        <View style={styles.statusRow}>
                            ...
                            <TouchableOpacity style={styles.downloadBtn}>
                                <Download size={16} color={COLORS.accentRed} />
                                <Text style={styles.downloadBtnText}>Receipt</Text>
                            </TouchableOpacity>
                        </View>
                        <View style={styles.bookingDetailsList}>
                            <Text style={styles.bookingDetailText}>Date: 15th March 2026</Text>
                            <Text style={styles.bookingDetailText}>Venue: Ramesh Palace, Jodhpur</Text>
                            <Text style={styles.bookingDetailText}>Manager: +91 98765 43210</Text>
                        </View>
                    </View>
                )}
                ...
                <View style={styles.section}>
                    ...
                    {artist.famousSongs.map((song, index) => (
